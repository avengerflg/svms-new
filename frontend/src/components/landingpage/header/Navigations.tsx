...
const Navigations = () => {
    ...
    return (<>
        <StyledButton
            ...
            endIcon={<IconChevronDown style={{ marginLeft: '-5px', marginTop: '2px' }} />}
        >
            Demos
        </StyledButton>
        {open && (
        ...
        <StyledButton color="inherit" variant="text" href="https://adminmart.github.io/premium-documentation/react/modernize/index.html">
            Documentation
        </StyledButton>
