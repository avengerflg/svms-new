      ...
      <Box mt={2} p={3} sx={{ borderColor: (theme: any) => theme.palette.divider, borderWidth: '1px', borderStyle: 'solid' }}>
        <Stack direction={'row'} gap={2} alignItems="center">
          ...
          <Typography variant="caption" color="textSecondary">
            <IconCircle fill="" fillOpacity={'0.1'} strokeOpacity="0.1" />{' '}
        ...
        <Stack direction="row" gap={1} alignItems="center">
          <Tooltip title="Like" placement="top">
            ...
            >
              <IconThumbUp onClick={() => handleLikeReply(post?.id, comment?.id)} />
            </Fab>
          </Tooltip>
          ...
          <Tooltip title="Reply" placement="top">
            <Fab sx={{ ml: 2 }} color="info" onClick={() => setShowReply(!showReply)}>
              <IconArrowBackUp />
            </Fab>
          </Tooltip>
