      ...
      <Grid container spacing={0} justifyContent="center" alignItems="center">
        ...
        <Grid
          ...
          <Stack direction={'row'} gap={2} alignItems="center" justifyContent="center" my={2}>
            <Fab color="primary" sx={{ backgroundColor: '#1877F2' }}>
              <IconBrandFacebook />
            </Fab>
            <Fab color="primary" sx={{ backgroundColor: '#1DA1F2' }}>
              <IconBrandTwitter />
            </Fab>
            <Fab color="error" sx={{ backgroundColor: '#EA4C89' }}>
              <IconBrandDribbble />
            </Fab>
            <Fab color="error" sx={{ backgroundColor: '#CD201F' }}>
              <IconBrandYoutube />
            </Fab>
