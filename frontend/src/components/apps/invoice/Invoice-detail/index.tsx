  ...
  return (<>
    ...
    >
      ...
      >
        ...
        <Box mt={1}>
          <Chip color="secondary" variant="outlined" label={orderDate}></Chip>
        </Box>
      </Box>
      ...
      <Box textAlign="right">
        {selectedInvoice.status === 'Shipped' ? (
          <Chip color="primary" label={selectedInvoice.status} />
        ) : selectedInvoice.status === 'Delivered' ? (
          <Chip color="success" label={selectedInvoice.status} />
        ) : selectedInvoice.status === 'Pending' ? (
          <Chip color="warning" label={selectedInvoice.status} />
        ) : (
          ''
        )}
      </Box>
